...
( [[ $NAME == "Ubuntu" ]] && ( [[ "$(echo ${VERSION_ID})" == "16.04" ]] || [[ "$(echo ${VERSION_ID})" == "18.04" ]] || [[ "$(echo ${VERSION_ID})" == "19.10" ]] )  ) || ( echo " - You must be running 16.04.x, 18.04.x or 19.04.x to install EOSIO." && exit 1 )
