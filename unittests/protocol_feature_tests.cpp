...
BOOST_AUTO_TEST_CASE( activate_preactivate_feature ) try {
   ...
   BOOST_CHECK_EXCEPTION( c.set_code( config::system_account_name, contracts::remme_bios_wasm() ),
   ...
   c.set_code( config::system_account_name, contracts::remme_bios_wasm() );
   c.set_abi( config::system_account_name, contracts::remme_bios_abi().data() );
...
BOOST_AUTO_TEST_CASE( fix_linkauth_restriction ) { try {
   ...
   validate_disallow("remme", "linkauth");
   validate_disallow("remme", "unlinkauth");
   validate_disallow("remme", "deleteauth");
   validate_disallow("remme", "updateauth");
   validate_disallow("remme", "canceldelay");
