...
fastUnstakeSystem = './fast.refund/remme.system/remme.system.wasm'
...
commands = [
    ...
    ('s', 'sys',                createSystemAccounts,       True,    "Create system accounts (remme.*)"),
...
parser.add_argument('--symbol', metavar='', help="The remme.system symbol", default='SYS')
