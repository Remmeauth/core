...
namespace eosiosystem {
   ...
   void system_contract::torewards( const name& payer, const asset& amount ) {
      require_auth( payer );
      const auto to_per_stake_pay = amount.amount * 0.6; //TODO: move to constants section
      const auto to_per_vote_pay  = share_pervote_reward_between_producers(amount.amount * 0.3); //TODO: move to constants section
