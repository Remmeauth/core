   ...
   class [[eosio::contract("rem.system")]] system_contract : public native {
      ...
      public:
       ...
       void setgiftattr( name value );
          ...
          *     The remaining inflation will be sent to the `rem.saving` account.
         ...
         using refund1_action = eosio::action_wrapper<"refund1"_n, &system_contract::refund1>;
