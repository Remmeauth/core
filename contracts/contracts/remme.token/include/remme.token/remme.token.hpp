...
namespace eosio {
   ...
   /**
    * @defgroup eosiotoken remme.token
    * @ingroup eosiocontracts
    * 
    * remme.token contract
    * 
    * @details remme.token contract defines the structures and actions that allow users to create, issue, and manage
    * tokens on eosio based blockchains.
    * @{
    */
   class [[eosio::contract("remme.token")]] token : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiotoken remme.token
} /// namespace eosio
