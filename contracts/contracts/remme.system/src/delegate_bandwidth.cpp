...
#include <remme.system/remme.system.hpp>
#include <remme.token/remme.token.hpp>
...
namespace eosiosystem {
    ...
    */
   struct [[eosio::table, eosio::contract("remme.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("remme.system")]] refund_request {
      name            owner;
