...
#include <remme.system/exchange_state.hpp>
#include <remme.system/native.hpp>
...
namespace eosiosystem {
   ...
   /**
    *
    * @defgroup eosiosystem remme.system
    * @ingroup eosiocontracts
    * remme.system contract defines the structures and actions needed for blockchain's core functionality.
    ...
    */
   struct [[eosio::table, eosio::contract("remme.system")]] name_bid {
     name            newname;
     name            high_bidder;
    ...
    */
   struct [[eosio::table, eosio::contract("remme.system")]] bid_refund {
      name         bidder;
      asset        amount;
    ...
    */
   struct [[eosio::table("global"), eosio::contract("remme.system")]] eosio_global_state : eosio::blockchain_parameters {
    ...
    */
   struct [[eosio::table("global2"), eosio::contract("remme.system")]] eosio_global_state2 {
      eosio_global_state2(){}
    ...
    */
   struct [[eosio::table("global3"), eosio::contract("remme.system")]] eosio_global_state3 {
      eosio_global_state3() { }
    ...
    */
   struct [[eosio::table("global4"), eosio::contract("remme.system")]] eosio_global_state4 {
      eosio_global_state4() { }
    ...
    */
   struct [[eosio::table, eosio::contract("remme.system")]] producer_info {
      name                  owner;
    ...
    */
   struct [[eosio::table, eosio::contract("remme.system")]] producer_info2 {
      name            owner;
    ...
    */
   struct [[eosio::table, eosio::contract("remme.system")]] voter_info {
    ...
    */
   struct [[eosio::table,eosio::contract("remme.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
    ...
    */
   struct [[eosio::table,eosio::contract("remme.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
    ...
    */
   struct [[eosio::table,eosio::contract("remme.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
    ...
    */
   struct [[eosio::table,eosio::contract("remme.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[eosio::table,eosio::contract("remme.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
    ...
    */
   class [[eosio::contract("remme.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{"remme.token"_n};
         static constexpr eosio::name ram_account{"remme.ram"_n};
         static constexpr eosio::name ramfee_account{"remme.ramfee"_n};
         static constexpr eosio::name stake_account{"remme.stake"_n};
         static constexpr eosio::name bpay_account{"remme.bpay"_n};
         static constexpr eosio::name vpay_account{"remme.vpay"_n};
         static constexpr eosio::name names_account{"remme.names"_n};
         static constexpr eosio::name saving_account{"remme.saving"_n};
         static constexpr eosio::name rex_account{"remme.rex"_n};
         static constexpr eosio::name null_account{"remme.null"_n};
          ...
          *     The remaining inflation will be sent to the `remme.saving` account.
   ...
   /** @}*/ // end of @defgroup eosiosystem remme.system
} /// eosiosystem
